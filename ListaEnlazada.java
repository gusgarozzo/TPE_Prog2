...
return cant;
    ...
    public TPE.Nodo buscarNodo (Object o){
        TPE.Nodo actual = this.cabeza;
        Integer cont = 0;
    ...
    private class IteratorNodos  implements Iterator<Object>{
    		private Nodo puntero; //Indica el siguiente elemento
        @Override
        ...
        @Override
        public Object next() {
            Object obj = puntero.obtenerSiguiente().obtenerValor();
            return obj;
        }
    }
